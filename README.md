...
**Finding a good developer conference can takes forever.** To simplify your life, I compiled a list of developer conferences that I personally attended. Because some them were really good and others total crap, I gave each conference a rating from `A+` (the best) to `F-` (the worst). Enjoy!
